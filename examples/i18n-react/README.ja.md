...
<div align="center"><strong>制約に縛られず、<a href="https://reactjs.org/">React</a> ベースの CRUD アプリケーションを構築できます。</strong><br>柔軟性を重視して開発された、オープンソースのヘッドレス Web アプリケーションフレームワークです。
