...
# refine で API に基づくビューを自動生成

[Inferencer](https://refine.dev/docs/packages/documentation/inferencer/) は、データ構造に基づいてリソース向けのビューを自動生成するためのパッケージです。生成されたコードは簡単にカスタマイズできるため、リソース用ビューの作成にかかる時間を減らすことを目的としています。
...
- より詳しい情報と使い方は、[refine Inferencer documentation](https://refine.dev/docs/packages/documentation/inferencer/) を参照してください。
- [チュートリアルの Inferencer セクションを参照してください](https://refine.dev/docs/tutorial/getting-started/antd/generate-crud-pages/#inferencer)
