...
# refine 向け Airtable 統合

[Airtable](https://www.airtable.com/) は、リレーショナルデータベースを作成して共有するためのクラウドベースのプラットフォームです。
...
- [refine Airtable example を参照してください](https://refine.dev/docs/examples/data-provider/airtable/)
