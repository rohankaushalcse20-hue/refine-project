...
# refine 向け StrapiV4 統合

[Strapi](https://strapi.io/) は、Web サイト、モバイルアプリケーション、eCommerce サイト、API の開発に使われるヘッドレス CMS です。
...
- [refine StrapiV4 data provider docs を参照してください](https://refine.dev/docs/packages/documentation/data-providers/strapi-v4/)
- [refine Strapiv4 data provider example を参照してください](https://refine.dev/docs/examples/data-provider/strapi-v4/)
