...
# refine 向け REST API データプロバイダー統合

Simple REST data provider は、標準的な API 設計に従う REST API を扱うための実装を提供するパッケージです。[json-server](https://github.com/typicode/json-server) パッケージを土台にしています。
...
- [refine simple-rest docs を参照してください。](https://refine.dev/docs/packages/documentation/data-providers/simple-rest/)
