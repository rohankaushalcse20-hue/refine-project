...
## refine 向け Appwrite 統合

[Appwrite](https://appwrite.io/) は、Web、Mobile、Flutter アプリケーションを開発するためのバックエンドプラットフォームです。
...
- data provider の使い方について詳しくは、[refine data provider documentation](https://refine.dev/docs/core/providers/data-provider) を参照してください。
- [Refine Appwrite docs を参照してください](https://refine.dev/docs/packages/documentation/data-providers/appwrite/)
