...
# refine 向け Supabase 統合

[Supabase](https://supabase.com/) は、オープンソースの Firebase 代替です。
...
- [refine Supabase docs を参照してください](https://refine.dev/docs/packages/documentation/data-providers/supabase/#introduction)
- [Supabase 公式 docs の refine 統合を参照してください](https://supabase.com/docs/guides/getting-started/tutorials/with-refine)
- [refine Supabase data provider example を参照してください](https://refine.dev/docs/examples/data-provider/supabase/)
