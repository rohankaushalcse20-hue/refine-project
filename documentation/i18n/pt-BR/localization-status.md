# Cobertura de localização em pt-BR

Esta nota registra o estado atual da localização em pt-BR e as áreas adicionadas neste ciclo.

## Incluído

- Configuração do locale `pt-BR` no Docusaurus e mensagens básicas do tema.
- Páginas principais de entrada, incluindo visão geral e início rápido.
...
- Introdução ao tutorial para quem prefere começar com uma aplicação CRUD guiada.
