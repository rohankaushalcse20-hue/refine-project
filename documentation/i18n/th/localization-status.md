# ขอบเขต localization ภาษาไทย

เอกสารนี้สรุปขอบเขตปัจจุบันของ locale `th` และ localization slices ที่เพิ่มในการอัปเดตนี้

## เนื้อหาที่มีแล้ว

- การตั้งค่า locale ภาษาไทยใน Docusaurus
- ข้อความ UI ค่าเริ่มต้นของ Docusaurus theme
